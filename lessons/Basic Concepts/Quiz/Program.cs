...
public class Program
{
	...
	{	
        ...
        //The area enclosed by a circle of radius r is πr², where π (pi) is the constant ratio of
        // the circumference of any circle to its diameter, and r is the radius.
